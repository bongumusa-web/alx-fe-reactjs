...
function UserProfile() {
  return (
    <div className="bg-gray-100 sm:p-4 md:p-8 md:max-w-sm max-w-sm mx-auto my-20 rounded-lg shadow-lg">
      <img src={myprofile} alt="User" className="rounded-full w-24 h-24 md:w-36 md:h-36 mx-auto bg-red-200" />
